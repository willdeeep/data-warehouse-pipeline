...
![Picture of the ISS](https://www.esa.int/var/esa/storage/images/esa_multimedia/
...
def example_astronauts():
    """
    Example DAG demonstrating basic Airflow patterns and API integration.
    ...
    @task(
        ...
        # outlets=["current_astronauts"]  # Asset functionality removed
