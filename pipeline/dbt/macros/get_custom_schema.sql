...
- staging/intermediate models → dev_warehouse (for development/testing)
...
{% macro generate_schema_name(custom_schema_name, node) -%}
    ...
    {%- elif target.name == 'prod' -%}
        ...
        {%- if 'staging' in model_path or 'intermediate' in model_path -%}
            {# Staging and intermediate models go to dev_warehouse #}
            dev_warehouse
